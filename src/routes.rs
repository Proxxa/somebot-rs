...
//     info!(
//         "TOS file path: {}",
//         concat!(env!("CARGO_MANIFEST_DIR"), "/src/", "./static_data/tos.txt")
//     );
//     let time = File::open(concat!(
...
//         "Last Updated {}\n\n{}",
//         TOS_TIMESTAMP.clone(),
//         include_str!("./static_data/tos.txt")
//     )
// }

// #[rocket::get("/tos")]
// pub fn privacy_policy() -> String {
//     static PRIVACY_TIMESTAMP: Lazy<String> = Lazy::new(|| {
//         let time = File::open(concat!(
//             env!("CARGO_MANIFEST_DIR"),
//             "/src/",
//             "./static_data/privacy_policy.txt"
//         ))
...
//     format!(
//         "Last Updated {}\n\n{}",
//         PRIVACY_TIMESTAMP.clone(),
//         include_str!("./static_data/privacy_policy.txt")
//     )
// }
